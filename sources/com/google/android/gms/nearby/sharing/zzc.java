    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(SharedContent sharedcontent, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 8, sharedcontent.zzvi(), i, false);
        zzb.zza(parcel, 9, sharedcontent.zzvj(), i, false);
        zzb.zzH(parcel, j);
    }
    ...
    public SharedContent zzeI(Parcel parcel)
    {
...
_L4:
    ...
    public SharedContent[] zzha(int i)
    {
