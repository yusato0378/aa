...
public class StreetViewPanoramaFragment extends Fragment
{
    ...
    static class zzb extends com.google.android.gms.dynamic.zza
    {
        ...
        public void zztD()
        {
            ...
            try
            {
                ...
                zzauc.zza(new zza(zzacp, istreetviewpanoramafragmentdelegate));
    ...
    public void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback onstreetviewpanoramareadycallback)
    {
        ...
        zzaus.getStreetViewPanoramaAsync(onstreetviewpanoramareadycallback);
    }
    ...
    public void onAttach(Activity activity)
    {
        ...
        zzb.zza(zzaus, activity);
    }

    public void onCreate(Bundle bundle)
    {
        super.onCreate(bundle);
        zzaus.onCreate(bundle);
    }

    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
    {
        return zzaus.onCreateView(layoutinflater, viewgroup, bundle);
    }
    ...
    public void onInflate(Activity activity, AttributeSet attributeset, Bundle bundle)
    {
        ...
        zzaus.onInflate(activity, attributeset, bundle);
    }
    ...
    public void onSaveInstanceState(Bundle bundle)
    {
        ...
        zzaus.onSaveInstanceState(bundle);
    }
