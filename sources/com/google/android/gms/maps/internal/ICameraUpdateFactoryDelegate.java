    ...
    extends IInterface
{
        ...
        implements ICameraUpdateFactoryDelegate
    {
        ...
        public static ICameraUpdateFactoryDelegate zzbo(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
...
_L1:
            ...
            cameraposition = com.google.android.gms.dynamic.zzd.zza.zzat(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            parcel1.readException();
            latlngbounds = com.google.android.gms.dynamic.zzd.zza.zzat(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return latlngbounds;
            parcel.writeInt(0);
