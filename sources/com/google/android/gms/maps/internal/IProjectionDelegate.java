    ...
    extends IInterface
{
        ...
        implements IProjectionDelegate
    {
        ...
        public static IProjectionDelegate zzbO(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                parcel = fromScreenLocation(com.google.android.gms.dynamic.zzd.zza.zzat(parcel.readStrongBinder()));
...
_L1:
            ...
            if(parcel1.readInt() != 0)
                zzd1 = LatLng.CREATOR.zzei(parcel1);
            parcel1.recycle();
            parcel.recycle();
            return zzd1;
            zzd1 = null;
...
_L3:
            ...
            point = LatLng.CREATOR.zzei(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
            return point;
...
_L1:
            VisibleRegion visibleregion = VisibleRegion.CREATOR.zzes(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
...
_L1:
            ...
            parcel1.readException();
            latlng = com.google.android.gms.dynamic.zzd.zza.zzat(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return latlng;
            parcel.writeInt(0);
...
_L3:
            ...
            if(parcel1.readInt() == 0)
                break MISSING_BLOCK_LABEL_91;
            latlng = Point.CREATOR.zzed(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
            return latlng;
