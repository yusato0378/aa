    ...
    extends IInterface
{
        ...
        implements IStreetViewPanoramaFragmentDelegate
    {
        ...
        public static IStreetViewPanoramaFragmentDelegate zzbR(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
            ...
            throws RemoteException
        {
            ...
            case 2: // '\002'
                ...
                if(parcel.readInt() != 0)
                    streetviewpanoramaoptions = StreetViewPanoramaOptions.CREATOR.zzec(parcel);
                else
            ...
            case 12: // '\f'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                getStreetViewPanoramaAsync(zzv.zza.zzbN(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
        }
        ...
        implements IStreetViewPanoramaFragmentDelegate
    {
            ...
            throws RemoteException
        {
            ...
            istreetviewpanoramadelegate = IStreetViewPanoramaDelegate.zza.zzbQ(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
