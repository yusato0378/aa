    ...
    extends IInterface
{
        ...
        implements zzf
    {
        ...
        public static zzf zzbW(IBinder ibinder)
        {
            if(ibinder == null)
                return null;
            ...
            throws RemoteException
        {
            ...
            case 19: // '\023'
                parcel.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                boolean flag4 = zza(zzbW(parcel.readStrongBinder()));
                parcel1.writeNoException();
                i = ((flag1) ? 1 : 0);
                if(flag4)
                    i = 1;
            ...
            case 21: // '\025'
                parcel.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                zzn(com.google.android.gms.dynamic.zzd.zza.zzat(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            if(parcel.readInt() != 0)
                obj = BitmapDescriptorParcelable.CREATOR.zzet(parcel);
...
_L1:
            LatLngBounds latlngbounds = LatLngBounds.CREATOR.zzeh(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
            return latlngbounds;
...
_L3:
            ...
            throws RemoteException
        {
            ...
            if(parcel1.readInt() == 0) goto _L2; else goto _L1
_L1:
            LatLng latlng = LatLng.CREATOR.zzei(parcel1);
_L4:
            parcel1.recycle();
            parcel.recycle();
            return latlng;
