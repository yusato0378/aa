    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GroundOverlayOptionsParcelable groundoverlayoptionsparcelable, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, groundoverlayoptionsparcelable.zztW(), i, false);
        zzb.zzH(parcel, j);
    }
    ...
    public GroundOverlayOptionsParcelable zzev(Parcel parcel)
    {
    ...
    public GroundOverlayOptionsParcelable[] zzgA(int i)
    {
