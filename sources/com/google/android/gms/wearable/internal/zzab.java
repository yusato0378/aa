    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(DataItemParcelable dataitemparcelable, Parcel parcel, int i)
    {
        ...
        zzb.zzc(parcel, 1, dataitemparcelable.zzzH);
        zzb.zza(parcel, 2, dataitemparcelable.getUri(), i, false);
        zzb.zza(parcel, 4, dataitemparcelable.zzyX(), false);
    ...
    public DataItemParcelable zzgc(Parcel parcel)
    {
        byte abyte0[];
        Object obj;
        Object obj1;
...
_L4:
    ...
    public DataItemParcelable[] zziN(int i)
    {
