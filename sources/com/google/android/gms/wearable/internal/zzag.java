    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GetChannelInputStreamResponse getchannelinputstreamresponse, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, getchannelinputstreamresponse.zzaMf, i, false);
        zzb.zzH(parcel, j);
    }
    ...
    public GetChannelInputStreamResponse zzgg(Parcel parcel)
    {
        int j = 0;
    ...
    public GetChannelInputStreamResponse[] zziR(int i)
    {
