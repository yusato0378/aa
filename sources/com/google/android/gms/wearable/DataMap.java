...
public class DataMap
{
    ...
    public static DataMap fromByteArray(byte abyte0[])
    {
        try
        {
            abyte0 = zznm.zza(new com.google.android.gms.internal.zznm.zza(zznn.zzs(abyte0), new ArrayList()));
        }
...
_L8:
    ...
    public int hashCode()
    {
        return zzaKF.hashCode() * 29;
    }

    public boolean isEmpty()
    {
        return zzaKF.isEmpty();
    }
    ...
    {
        String s;
        for(Iterator iterator = datamap.keySet().iterator(); iterator.hasNext(); zzaKF.put(s, datamap.get(s)))
            s = (String)iterator.next();
    ...
    {
        zzaKF.put(s, Boolean.valueOf(flag));
    }

    public void putByte(String s, byte byte0)
    {
        zzaKF.put(s, Byte.valueOf(byte0));
    }
    ...
    {
        zzaKF.put(s, arraylist);
    }

    public void putDouble(String s, double d)
    {
        zzaKF.put(s, Double.valueOf(d));
    }

    public void putFloat(String s, float f)
    {
        zzaKF.put(s, Float.valueOf(f));
    }
    ...
    public Bundle toBundle()
    {
        ...
        String s;
        for(Iterator iterator = zzaKF.keySet().iterator(); iterator.hasNext(); zza(bundle, s, zzaKF.get(s)))
            s = (String)iterator.next();
    ...
    {
        return zzny.zzf(zznm.zza(this).zzaMX);
    }

    public String toString()
    {
        return zzaKF.toString();
    }

    public static final String TAG = "DataMap";
    private final HashMap zzaKF = new HashMap();
}
