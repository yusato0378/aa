...
_L10:
    ...
    public static long zza(int i, float f)
    {
        ...
        case 4: // '\004'
        case 5: // '\005'
            return zzs(i, Float.floatToIntBits(f));
        }
    }
    ...
    public static long zza(TypedValue typedvalue)
    {
        ...
        case 16: // '\020'
            return zzii(typedvalue.data);

        case 5: // '\005'
            return zzs(128, typedvalue.data);
        }
    }

    public static long zzii(int i)
    {
        if(i < 0)
        {
            if(i == -1 || i == -2)
    ...
    private static long zzs(int i, int j)
    {
