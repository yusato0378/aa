    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(LoyaltyWalletObject loyaltywalletobject, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, loyaltywalletobject.zzaIz, false);
        zzb.zza(parcel, 4, loyaltywalletobject.zzaIA, false);
        zzb.zza(parcel, 5, loyaltywalletobject.zzaIB, false);
        zzb.zza(parcel, 6, loyaltywalletobject.zzate, false);
        zzb.zza(parcel, 7, loyaltywalletobject.zzaIC, false);
        zzb.zza(parcel, 8, loyaltywalletobject.zzaID, false);
        zzb.zza(parcel, 9, loyaltywalletobject.zzaIE, false);
        zzb.zza(parcel, 10, loyaltywalletobject.zzaIF, false);
        zzb.zza(parcel, 11, loyaltywalletobject.zzaIG, false);
        zzb.zzc(parcel, 12, loyaltywalletobject.state);
        zzb.zzc(parcel, 13, loyaltywalletobject.zzaIH, false);
        zzb.zza(parcel, 14, loyaltywalletobject.zzaII, i, false);
        zzb.zzc(parcel, 15, loyaltywalletobject.zzaIJ, false);
        zzb.zza(parcel, 17, loyaltywalletobject.zzaIL, false);
        zzb.zza(parcel, 16, loyaltywalletobject.zzaIK, false);
        zzb.zza(parcel, 19, loyaltywalletobject.zzaIN);
        zzb.zzc(parcel, 18, loyaltywalletobject.zzaIM, false);
        zzb.zzc(parcel, 21, loyaltywalletobject.zzaIP, false);
        zzb.zzc(parcel, 20, loyaltywalletobject.zzaIO, false);
        zzb.zza(parcel, 23, loyaltywalletobject.zzaIR, i, false);
        zzb.zzc(parcel, 22, loyaltywalletobject.zzaIQ, false);
        zzb.zzH(parcel, j);
    }
