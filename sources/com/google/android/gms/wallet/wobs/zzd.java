    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(LoyaltyPointsBalance loyaltypointsbalance, Parcel parcel, int i)
    {
        ...
        zzb.zzc(parcel, 2, loyaltypointsbalance.zzaKn);
        zzb.zza(parcel, 3, loyaltypointsbalance.zzaKo, false);
        zzb.zza(parcel, 4, loyaltypointsbalance.zzaKp);
        zzb.zza(parcel, 5, loyaltypointsbalance.zzaIq, false);
        zzb.zza(parcel, 6, loyaltypointsbalance.zzaKq);
        zzb.zzc(parcel, 7, loyaltypointsbalance.zzaKr);
        zzb.zzH(parcel, i);
    }
    ...
    public LoyaltyPointsBalance[] zzir(int i)
    {
