    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(SessionReadRequest sessionreadrequest, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 3, sessionreadrequest.zzjm());
        zzb.zza(parcel, 4, sessionreadrequest.zzoD());
        zzb.zzc(parcel, 5, sessionreadrequest.getDataTypes(), false);
        zzb.zzc(parcel, 6, sessionreadrequest.getDataSources(), false);
        zzb.zza(parcel, 7, sessionreadrequest.zzpz());
        zzb.zza(parcel, 8, sessionreadrequest.zzpk());
        zzb.zzb(parcel, 9, sessionreadrequest.getExcludedPackages(), false);
        zzb.zza(parcel, 10, sessionreadrequest.zzpf(), false);
    ...
    public SessionReadRequest zzcG(Parcel parcel)
    {
    ...
    public SessionReadRequest[] zzel(int i)
    {
