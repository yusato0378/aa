...
public class zzni extends zzi
{
    ...
    static final class zzb extends zza
    {
        ...
        public void zza(int i, FullWallet fullwallet, Bundle bundle)
        {
            Activity activity = (Activity)zzaKg.get();
            if(activity == null)
            {
        ...
        private final WeakReference zzaKg;

        public zzb(Activity activity, int i)
        {
            zzaKg = new WeakReference(activity);
            zzTc = i;
        }
    }
    ...
    private Bundle zzyR()
    {
        return zza(zzaJt, zzpf.getPackageName(), zzKw, mTheme);
    }
    ...
    public void zza(FullWalletRequest fullwalletrequest, int i)
    {
        ...
        try
        {
            ((zznd)zzlX()).zza(fullwalletrequest, bundle, zzb1);
            return;
        }
        // Misplaced declaration of an exception variable
    ...
    public void zza(MaskedWalletRequest maskedwalletrequest, int i)
    {
        ...
        try
        {
            ((zznd)zzlX()).zza(maskedwalletrequest, bundle, zzb1);
            return;
        }
        // Misplaced declaration of an exception variable
    ...
    public void zza(NotifyTransactionStatusRequest notifytransactionstatusrequest)
    {
        ...
        try
        {
            ((zznd)zzlX()).zza(notifytransactionstatusrequest, bundle);
            return;
        }
        // Misplaced declaration of an exception variable
    ...
    public void zze(String s, String s1, int i)
    {
        ...
        try
        {
            ((zznd)zzlX()).zza(s, s1, bundle, zzb1);
            return;
        }
        // Misplaced declaration of an exception variable
        catch(String s)
