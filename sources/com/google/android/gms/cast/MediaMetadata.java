...
public class MediaMetadata
{
    private static class zza
    {
        ...
        public zza zzb(String s, String s1, int i)
        {
            zzMu.put(s, s1);
            zzMv.put(s1, s);
            zzMw.put(s, Integer.valueOf(i));
            return this;
        }

        public String zzbi(String s)
        {
            return (String)zzMu.get(s);
        }

        public String zzbj(String s)
        {
            return (String)zzMv.get(s);
        }

        public int zzbk(String s)
        {
            s = (Integer)zzMw.get(s);
            if(s != null)
                return s.intValue();
            else
                return 0;
        ...
        private final Map zzMu = new HashMap();
        private final Map zzMv = new HashMap();
        private final Map zzMw = new HashMap();
...
_L3:
        break MISSING_BLOCK_LABEL_249;
_L4:
        jsonobject.put(zzMr.zzbi(s), zzMs.getString(s));
        break MISSING_BLOCK_LABEL_249;
_L5:
        jsonobject.put(zzMr.zzbi(s), zzMs.getInt(s));
        break MISSING_BLOCK_LABEL_249;
_L6:
        jsonobject.put(zzMr.zzbi(s), zzMs.getDouble(s));
        break MISSING_BLOCK_LABEL_249;
_L2:
