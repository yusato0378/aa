    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GameEntity gameentity, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 10, gameentity.zzpM());
        zzb.zza(parcel, 11, gameentity.zzpO());
        zzb.zza(parcel, 12, gameentity.zzpP(), false);
        zzb.zzc(parcel, 13, gameentity.zzpQ());
        ...
        zzb.zza(parcel, 22, gameentity.zzpN());
