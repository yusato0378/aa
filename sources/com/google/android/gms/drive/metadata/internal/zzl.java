    ...
    implements SearchableCollectionMetadataField
{
    ...
    private void zzc(DataHolder dataholder)
    {
        ...
        Object obj = (DataHolder)dataholder.zzlm().getParcelable("parentsExtraHolder");
        if(obj != null)
...
_L3:
    ...
    protected Collection zzd(DataHolder dataholder, int i, int j)
    {
        ...
        return ((ParentDriveIdSet)arraylist1.get(i)).zzB(l);
    }

    public void zzd(DataHolder dataholder)
    {
        Bundle bundle;
        bundle = dataholder.zzlm();
        if(bundle == null)
            return;
        dataholder;
        JVM INSTR monitorenter ;
