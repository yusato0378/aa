    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(PlaceImpl placeimpl, Parcel parcel, int i)
    {
        ...
        zzb.zza(parcel, 2, placeimpl.zztd(), false);
        zzb.zza(parcel, 3, placeimpl.zztf(), i, false);
        zzb.zza(parcel, 4, placeimpl.getLatLng(), i, false);
        zzb.zza(parcel, 5, placeimpl.zzsZ());
        zzb.zza(parcel, 6, placeimpl.getViewport(), i, false);
        zzb.zza(parcel, 7, placeimpl.zzte(), false);
        zzb.zza(parcel, 8, placeimpl.getWebsiteUri(), i, false);
        zzb.zza(parcel, 9, placeimpl.zzsT());
        zzb.zza(parcel, 10, placeimpl.getRating());
        zzb.zzc(parcel, 11, placeimpl.getPriceLevel());
        zzb.zza(parcel, 12, placeimpl.zztc());
        zzb.zza(parcel, 13, placeimpl.zzsY(), false);
        zzb.zza(parcel, 14, placeimpl.getAddress(), false);
        zzb.zza(parcel, 15, placeimpl.getPhoneNumber(), false);
        zzb.zzb(parcel, 17, placeimpl.zztb(), false);
        zzb.zza(parcel, 16, placeimpl.zzta(), false);
        zzb.zzc(parcel, 1000, placeimpl.zzzH);
        zzb.zza(parcel, 19, placeimpl.getName(), false);
        zzb.zza(parcel, 18, placeimpl.zzasJ);
    ...
    public PlaceImpl zzdR(Parcel parcel)
    {
