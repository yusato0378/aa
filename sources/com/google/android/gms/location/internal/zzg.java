            ...
            throws RemoteException
        {
            ...
            case 1: // '\001'
                ...
                if(parcel.readInt() != 0)
                    ...
                    obj = null;
                zza(((List) (obj1)), ((PendingIntent) (obj)), zzf.zza.zzbg(parcel.readStrongBinder()), parcel.readString());
            ...
            case 57: // '9'
                ...
                if(parcel.readInt() != 0)
                    ...
                    obj1 = null;
                zza(((GeofencingRequest) (obj)), ((PendingIntent) (obj1)), zzf.zza.zzbg(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 2: // '\002'
                ...
                if(parcel.readInt() != 0)
                    ...
                    obj = null;
                zza(((PendingIntent) (obj)), zzf.zza.zzbg(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;

            case 3: // '\003'
                parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                zza(parcel.createStringArray(), zzf.zza.zzbg(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;

            case 4: // '\004'
                parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                zza(zzf.zza.zzbg(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;
            ...
            case 60: // '<'
                parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                if(parcel.readInt() != 0)
                    obj = GestureRequest.CREATOR.zzdC(parcel);
                else
                    obj = null;
                if(parcel.readInt() != 0)
                    parcel = (PendingIntent)PendingIntent.CREATOR.createFromParcel(parcel);
            ...
            case 8: // '\b'
                ...
                zza(((LocationRequest) (obj)), com.google.android.gms.location.zzd.zza.zzbe(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 20: // '\024'
                ...
                if(parcel.readInt() != 0)
                    obj = LocationRequest.CREATOR.createFromParcel(parcel);
                zza(((LocationRequest) (obj)), com.google.android.gms.location.zzd.zza.zzbe(parcel.readStrongBinder()), parcel.readString());
                parcel1.writeNoException();
                return true;
            ...
            case 52: // '4'
                ...
                obj = obj2;
                if(parcel.readInt() != 0)
                    obj = LocationRequestInternal.CREATOR.zzdH(parcel);
                zza(((LocationRequestInternal) (obj)), com.google.android.gms.location.zzd.zza.zzbe(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 10: // '\n'
                parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                zza(com.google.android.gms.location.zzd.zza.zzbe(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            ...
            case 59: // ';'
                ...
                obj = obj3;
                if(parcel.readInt() != 0)
                    obj = LocationRequestUpdateData.CREATOR.zzdI(parcel);
            ...
            if(parcel.readInt() != 0)
                ...
                obj = null;
            zza(((LocationSettingsRequest) (obj)), zzh.zza.zzbi(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;
        }
    }
...
_L6:
            ...
            gesturerequest = Status.CREATOR.createFromParcel(parcel1);
_L7:
            parcel1.recycle();
            parcel.recycle();
...
_L4:
            ...
            parcel.writeString(s);
            zzlW.transact(63, parcel, parcel1, 0);
            parcel1.readException();
            parcel1.recycle();
            parcel.recycle();
            return;
...
_L1:
        ...
        public ActivityRecognitionResult zzcE(String s)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L3:
        ...
        public LocationAvailability zzcG(String s)
            throws RemoteException
        {
            Parcel parcel;
            Parcel parcel1;
...
_L3:
    ...
    public abstract ActivityRecognitionResult zzcE(String s)
        throws RemoteException;

    public abstract Location zzcF(String s)
        throws RemoteException;

    public abstract LocationAvailability zzcG(String s)
        throws RemoteException;
