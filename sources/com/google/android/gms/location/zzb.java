    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void zza(GestureRequest gesturerequest, Parcel parcel, int i)
    {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 1, gesturerequest.zzsA(), false);
    ...
    public GestureRequest zzdC(Parcel parcel)
    {
    ...
    public GestureRequest[] zzfz(int i)
    {
