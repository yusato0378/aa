...
//            GrowthPush, UnityActivity

public class UnityNativeActivity extends UnityPlayerNativeActivity
{

    public UnityNativeActivity()
    {
        started = false;
    }
...
_L4:
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        bundle = new DefaultReceiveHandler() {
            ...
            final UnityNativeActivity this$0;

            
            {
                this$0 = UnityNativeActivity.this;
                super();
            }
        }
;
        bundle.setCallback(new com.growthpush.handler.DefaultReceiveHandler.Callback() {
            ...
            public void onOpen(Context context, Intent intent)
            {
                ...
                intent = new Intent(context, jp/co/cyberagent/gn/plugin/PluginNativeActivity);
